...
public class FaissRemoteBertEmbeddingsStore implements BertEmbeddingsStore {
    ...
    public void deleteByDocumentId(Long documentId) {
        ...
        // Purge de tous les chunks du document cote service FAISS.
        restClient.delete()
                .uri("/api/faiss/documents/{documentId}", documentId)
                .retrieve()
                .toBodilessEntity();
    }
    ...
    private BertEmbeddingDocument fromRemoteDocument(FaissRemoteStoreDocument document) {
        return new BertEmbeddingDocument(
                document.documentId(),
                document.chunkIndex() == null ? 0 : document.chunkIndex(),
                document.chunkCount() == null ? 1 : document.chunkCount(),
                document.title(),
                document.author(),
                document.category(),
                document.filename(),
